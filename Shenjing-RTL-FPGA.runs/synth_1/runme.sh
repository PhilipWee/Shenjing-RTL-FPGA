...
HD_PWD='C:/Users/Philip Wee/Documents/Dissertation/Shenjing-RTL-FPGA/Shenjing-RTL-FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shenjing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shenjing.tcl
